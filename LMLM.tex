...
\uncover<1->{
Recall the {\color{brown}{chain rule}}. If
$$
...
\uncover<2->{
If $m = n = p = 1$ then customary to write
$$
...
\begin{frame}[fragile]{Chain Rule Example I}
\uncover<1->{
Since
$$
...
\frac{\partial f_7}{\partial x} & \frac{\partial f_7}{\partial
  y} \end{array} \right)\bigg|_{x=u_6, y=u_5}
=
\left( \begin{array}{cc}
1 & 1 \end{array} \right)
$$
...
\begin{frame}[fragile]{Chain Rule Example II}
\uncover<1->{
Since
$$
...
\frac{\partial f_5}{\partial x} \end{array} \right)\bigg|_{x=u_4}
=
\left( \begin{array}{c}
\exp{u_4} \\
...
\begin{frame}[fragile]{Chain Rule Example III}
\uncover<1->{
Since
$$
\begin{aligned}
...
$$
D(f_7 \circ \langle f_6, f_5\rangle)(u_4) = Df_7(f_6(u_4), f_5(u_4))
\circ D\langle f_6, f_5\rangle(u_4)
$$
}
\uncover<3->{
$$
