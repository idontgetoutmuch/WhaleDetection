...
\begin{frame}[fragile]{The Multivariate Chain Rule}
  \uncover<1->{
    ...
    We need the multivariate form: if $f(u) = g(h_1(u),h_2(u))$ and
    $x = h_1(u)$ and $y = h_2(u)$ then
...
\uncover<2->{
Again, more suggestively we can write
...
\uncover<2->{
Using the {\color{brown}{chain rule}}
$$
\begin{aligned}
\frac{\partial u_7}{\partial u_1} &=
{\color{blue}{\frac{\partial u_7}{\partial u_6}}}\frac{\partial u_6}{\partial u_1} +
{\color{blue}{\frac{\partial u_7}{\partial u_5}}}\frac{\partial u_5}{\partial u_1} \\
&=
...
\begin{aligned}
\frac{\partial u_6}{\partial u_1} &=
{\color{blue}{\frac{\partial u_6}{\partial u_4}}}\frac{\partial
  u_4}{\partial u_1} \\
&=
\exp{u_4}\frac{\partial u_4}{\partial u_1}
\end{aligned}
$$
}
\uncover<2->{
...
$$
\begin{aligned}
\frac{\partial u_5}{\partial u_1} &= \frac{\partial u_5}{\partial
  u_4}\frac{\partial u_4}{\partial u_1} = \cos u_4 \frac{\partial u_4}{\partial u_1}
\end{aligned}
$$
}
\uncover<2->{
...
{\color{blue}{\frac{\partial u_4}{\partial
  u_3}}}\frac{\partial u_3}{\partial u_1} +
{\color{blue}{\frac{\partial u_4}{\partial
  u_2}}}\frac{\partial u_2}{\partial u_1} \\
&=
...
\begin{frame}[fragile]{Chain Rule Example}
\uncover<1->{
Using the {\color{brown}{chain rule}} again
$$
...
\uncover<3->{
Again the {\color{brown}{chain rule}} gives
$$
\begin{aligned}
...
\uncover<2->{
The {\color{brown}{chain rule}} gives
$$
\begin{aligned}
\frac{\partial u_4}{\partial u_1} &=
